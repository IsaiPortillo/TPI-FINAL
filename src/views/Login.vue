...
<div id="contene">
 ...
 <div class="container-1 bd">
        <div class="bg">
            <div class="box 1">
            <h2>Tienes una cuenta?</h2>
            <button class="btn 1" id="btn1" v-on:click="iniciarsesion()">Iniciar Sesion</button>
            </div>
            <div class="box 2">
            <h2>No tienes una cuenta?</h2>
            <button class="btn 2" id="btn2" v-on:click="registrar()">Registrarse</button>
            </div>
        </div>
